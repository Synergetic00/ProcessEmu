...
//  /**
//   * Begin parsing XML data passed in from a FXApp. This code
...
//   * @throws IOException
//   */
//  public XML(FXApp parent, String filename) throws IOException, ParserConfigurationException, SAXException {
//    this(parent.createReader(filename));
//  }


  /**
   * Advanced users only; use loadXML() in FXApp. This is not a supported
  ...
  /**
   * Advanced users only; use loadXML() in FXApp.
   *
   * @nowebref
   */
  ...
  /**
   * Unlike the loadXML() method in FXApp, this version works with files
  ...
  public XML(InputStream input, String options) throws IOException, ParserConfigurationException, SAXException {
    //this(FXApp.createReader(input), options);  // won't handle non-UTF8
...
//    return write(FXApp.createWriter(output));
//  }
